...
-- 管理员表
CREATE TABLE `videomanager`.`user` IF NOT EXISTS  (
...
-- 管理员表
CREATE TABLE `videomanager`.`admin_user` IF NOT EXISTS(
...
-- 视频表
CREATE TABLE `videomanager`.`video` IF NOT EXISTS (
  `video_id` bigint(10) NOT NULL COMMENT '视频id',
...
-- 讲师表
CREATE TABLE `videomanager`.`teacher` IF NOT EXISTS  (
  `teacher_id` bigint(10) NOT NULL COMMENT '讲师id',
...
-- 课程表
CREATE TABLE `videomanager`.`course` IF NOT EXISTS (
